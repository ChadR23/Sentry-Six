// Centralized storage keys for UI persistence.
// Keeping these in one place makes future state centralization much easier.

export const CLIPS_MODE_KEY = 'teslareplay.ui.clipsMode';
